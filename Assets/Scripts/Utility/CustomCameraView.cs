...
public class CustomCameraView : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //float n = lookTarget.InverseTransformPoint(theCam.transform.position).sqrMagnitude; // distance to the near clip plane (screen)        
        //float n = (lookTarget.position - theCam.transform.position).sqrMagnitude; // distance to the near clip plane (screen)
